...
module mint_nft::sbt {
    ...
    fun init_module(resource_signer: &signer) {
        let collection_name = string::utf8(b"GENIE");
        let description = string::utf8(b"Description");
        let collection_uri = string::utf8(b"https://arweave.net/k-ytlgN66hHeO8zBg8c-f6Knbr7Prjhj1W9xkjSoXRc");
        let token_uri = string::utf8(b"https://arweave.net/iSiJNljZr8-XoGh2YYK6QAgqQeQeImPM9RNb9FyZR5E");
